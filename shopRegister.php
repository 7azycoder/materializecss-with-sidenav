                      ...
                      <form class="col s12" method="post" action="index.php">
                        <div class="row">
                          ...
                          <div class="input-field col s12 m6 l6">
                            ...
                            <input id="first_name" name="first_name" for="first" type="text" length="20" class="validate">
                            <label for="first">First Name</label>
                          </div>
                          <div class="input-field col s12 m6 l6">
                            <i class="material-icons prefix">account_circle</i>
                            <input id="last_name" name="last_name" for="last" type="text" length="20" class="validate">
                          ...
                          <div class="input-field col s12 m12 l12">
                            <i class="material-icons prefix">note_add</i>
                            <input id="shop_name" name="shop_name" for="shop_name" type="text" length="10" class="validate">
                            <label for="shop_name">Shop Name</label>
                          </div>
                            <div class="input-field col s12 m12 l12">
                            <i class="material-icons prefix">store</i>
                            <textarea id="shop_add" name="shop_add" for="address" class="materialize-textarea" length="100"></textarea>
                          ...
                          <div class="input-field col s12 m6 l6">
                            <i class="material-icons prefix">vpn_key</i>
                            <input id="password_again" name="password_again" for="password_again" type="password" class="validate" length="50">
